...
/*
    ...
    */
    ...
    {
        linedraw(scrx[i], scry[i], scrx[i+4], scry[i+4], 53, screen);
        linedraw(scrx[i], scry[i], scrx[(i+1)%4], scry[(i+1)%4], 53, screen);
        linedraw(scrx[i+4], scry[i+4], scrx[((i+1)%4)+4], scry[((i+1)%4)+4], 53, screen);
    }
}    
